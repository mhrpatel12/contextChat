...
//    CGSize maximumLabelSize = CGSizeMake(296, FLT_MAX);
    CGSize expectedLabelSize = [label.text sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:20.0f]}];
...
-(void) showActionAlert
{
    ...
    if((![ALApplozicSettings isBlockUserOptionHidden] && !self.channelKey && !self.conversationId) || (self.alChannel.type == GROUP_OF_TWO))
    {
